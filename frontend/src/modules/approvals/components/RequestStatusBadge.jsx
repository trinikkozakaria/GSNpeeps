...
const tone = {
  menunggu_atasan: "bg-amber-400/15 text-amber-800",
  menunggu_hr: "bg-amber-400/15 text-amber-800",
  menunggu_top_management: "bg-amber-400/15 text-amber-800",
...
export const RequestStatusBadge = ({ status }) => (
  <span
    className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${
      tone[status] ?? "bg-slate-200 text-slate-600"
    }`}
  >
