/**
 * Ikon garis sederhana untuk kartu metrik Dashboard HR. Inline SVG mengikuti gaya ikon yang
 * sudah dipakai di `components/layout/AppShell.jsx` (viewBox 24, stroke currentColor, ujung
 * bulat) sehingga tidak perlu menambah dependency icon set ke baseline (CLAUDE.md §3).
 */
const base = {
  viewBox: "0 0 24 24",
  fill: "none",
