...
export const AuthCard = ({ title, description, children, footer }) => (
  <main className="min-h-screen bg-white px-5 py-10 text-slate-900 sm:py-16">
    <section className="mx-auto max-w-md" aria-labelledby="auth-title">
      <Link to="/" className="inline-flex items-center gap-4 focus-visible:outline focus-visible:outline-2">
        <img src="/assets/logo.svg" alt="Logo GSN" className="h-14 w-14 object-contain" />
        <span>
          <span className="block text-xs font-semibold uppercase tracking-[0.25em] text-cyan-700">
