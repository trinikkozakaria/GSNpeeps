...
export const NotFoundPage = () => {
  ...
  return (
    <section aria-labelledby="not-found-title" className="mx-auto max-w-xl py-20 text-center">
      ...
      <Link
        to="/"
        className="mt-8 inline-flex min-h-11 items-center rounded-lg bg-cyan-300 px-4 py-2 font-semibold text-slate-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300"
      >
        Kembali ke beranda
      </Link>
    </section>
